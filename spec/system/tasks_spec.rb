...
describe 'タスク管理機能', type: :system do
  ...
  shared_examples_for 'ユーザーAが作成したタスクが表示される' do
  ...
  describe '一覧表示機能' do
    context 'ユーザーAがログインしているとき' do
      ...
      it_behaves_like 'ユーザーAが作成したタスクが表示される'
    end
  ...
  describe '新規作成機能' do
    ...
    context '新規作成画面で名称を入力しなかったとき' do
      let(:task_name) { '' }

      it '名称が「名前なし」で登録される' do
